...
extendLocale('en-US', {
  ...
  '08fa5338e66f8607d9c0d3dcbc37dcaa':
    'The defined style only takes effect for the current component. Example',
  ...
  'a6805f421af4ad6ba22d36ada035fb57':
    'Conditional expressions. Example: Chinese score > 80',
  '2bbdbdd4e495145be0210f9dbbd51623':
    'Return result when the condition judgment is passed',
  '68b470c1f89a1313fa7bd5a29711d236':
    'Return result when the condition judgment is not passed',
  '6d6bb636f1caa983b547cfd0caea4f57':
    'Conditional expressions; separate multiple ones with commas. Example: Chinese score > 80, math score > 80',
  ...
  'bbb34ce4fcf8cc55638791e2cd6b5a91':
    'Length of the generated UUID string, default is 32 bits',
  '16d1cccaeee00a302b1284a42c32e7c6': 'Date object',
  '0f191c47fa745787b516857118a830f2':
    "Timestamp format; pass 'x' for milliseconds. Default is 'x’ (without milliseconds).",
  '86ed1903b0ecfd7dda0cf16eb2957d43':
    'Week definition type, default is 1: 1 means 0-6 representing Monday to Sunday; 2 means 1-7 representing Monday to Sunday',
  ...
  '28b47401285328e4f3344f8fe3b0b62c':
    "Date format, default is 'YYYY-MM-DD HH:mm:ss'",
  '01da6313d7f314dbb9b5a2ebcb07f982': 'Date range string',
  '9c4072c8df4d2e1c6a4a294f9b7d3cce':
    "Value identifier: 0 or 'start' means get start time; 1 or 'end' means get end time",
  '333abdc80f42fd3b7ae9eff39c0940a5': 'Date format (optional)',
  '05fcb8b62afd03022c7fcb58279c3cee': "Separator (optional), default is ','",
  'e6f158f9a9d3f173ac7ef6821b409ba3':
    "For example, you can pass 'day', 'month', 'year' or `week`, etc.",
  ...
  '05a580edff795061ccd7a89009d6ac5a':
    "Unit, default is 'day' (compare up to the day)",
  'cd191a2ef9885e6b728a2d33a2b83a6c':
    "Inclusivity rule, default is '[]'. '[' means include; '(' means exclude. If using the inclusivity parameter, two indicators must be passed (e.g., '()' means both left and right ranges are excluded)",
  ...
  '75d4f99310ce6d885dfca27342babf3c':
    'If condition is met, return consequent; otherwise return alternate. Support multi-level nested IF functions. Equivalent to using JS expression directly: condition? consequent : alternate.',
  '33136429f20612f8bbe72998c71ee8fe':
    'If all conditions are met, return true; otherwise return false. Example: AND (Chinese score > 80, math score > 80): if both Chinese score and math score are greater than 80, return true; otherwise return false. Equivalent to JS expression: Chinese score > 80 && math score > 80.',
  '1aeeb99a79d7157e0f0ddd28298e9323':
    'If any condition is met, return true; otherwise return false. Example: OR (Chinese score > 80, math score > 80): if either Chinese score or math score is greater than 80, return true; otherwise return false. Equivalent to JS expression: Chinese score > 80 || math score > 80.',
  '171db2606fa6338498d61e060fb35fa3':
    'XOR processing: considered true if there is an odd number of true values among multiple expressions. Example: XOR (Chinese score > 80, math score > 80, English score > 80): if 1 or 3 of the three scores are greater than 80, return true; otherwise return false.',
  '4682a020956e97b8c0b7dc44cbc8e6b9':
    'Judgment function collection, equivalent to combining multiple else if into one. Example: IFS (Chinese score > 80, "Excellent", Chinese score > 60, "Good", "Keep trying"): if Chinese score > 80, return "Excellent"; else if Chinese score > 60, return "Good"; else return "Keep trying".',
  'f9453bc31ac6fe8ef61a61a2850fa032':
    'Return the absolute value of the input number.',
  '09a1d2393e17de145f9c262cb1c5e1d9':
    'Get the maximum value. If there is only one parameter and it is an array, calculate the value within this array.',
  '7222f45e540b0657722bd4f7a54bcf22':
    'Get the minimum value. If there is only one parameter and it is an array, calculate the value within this array.',
  '50a1a58c87881587606fb70bbc2153d2':
    'Calculate the sum. If there is only one parameter and it is an array, calculate the value within this array.',
  '725841e49e7cee7e181be34045445c1f':
    'Round the number down to the nearest integer.',
  'b846dbcd933827df3adbc3e670604f98':
    'Return the remainder of dividing two numbers. The parameter "number" is the dividend, and the "divisor" is the divisor.',
  '62aa0442656d4fe0c0a3138126a5bd1f': 'Pi 3.1415...',
  'dc202add9d61722020749e8736171ff3':
    'Round the number to the specified digit (decimal places can be set).',
  'ca7925a755cb56396b3ab1b9b63cf51e':
    'Round the number down to the specified digit (decimal places can be set).',
  '7202f9d9bac24f0fadea86ac48ca7447':
    'Round the number up to the specified digit (decimal places can be set).',
  '6d5e0d8f13fa0d2948e2eaf727db46b3':
    'Calculate the square root. The parameter "number" must be non-negative',
  '61a86a9972e37fb43b2e22e42c6421ad':
    'Return the average of all parameters. If there is only one parameter and it is an array, calculate the value within this array.',
  '0df788e02d17497a8b1c1483728ac1ea':
    'Return the sum of squares of the differences between data points and the mean (data deviation). If there is only one parameter and it is an array, calculate the value within this array.',
  '4436a75ae004133fc666f673ec73e323':
    'The average of the absolute deviations of data points from their arithmetic mean.',
  'f592f5392d9182d2b5c64e105dad789d':
    'The harmonic mean of data points. If there is only one parameter and it is an array, calculate the value within this array.',
  '6fbd00a840f63b0561e5711309e527f4': 'The kth largest value in the dataset.',
  'e8074346fd95c461d504ee8caff98976':
    'Convert the number to Chinese capitalized currency.',
  '546906596299e8cb04c44a8cd2e23ae5':
    'Return a uniformly distributed random real number greater than or equal to 0 and less than 1. Change every time the calculation is triggered. Example: `RAND()*100`, return a random number between 0-100.',
  'c72b6cf156e72fafafadd8170595506b': 'Take the last item of the data.',
  '486a898cb178844dd6827e2da008d5cb':
    'Return the base raised to the power of the exponent. The parameter "base" is the base number, and "exponent" is the exponent. If the parameter is invalid, return the base itself; if the calculation result is invalid, return NaN.',
  'ef12ca62598730039a2769f1159e7d6e':
    'Return a substring of the specified length from the left side of the input text.',
  'e5dc2e9b87f1e2650d47ea4be1e0c0da':
    'Return a substring of the specified length from the right side of the input text.',
  'd39df9c11954e0a3b9caf8151b0468b6': 'Calculate the length of the text.',
  '6338ad33d82fd64378dc1a769fb67fcc':
    'Calculate the total length of all texts in the text collection.',
  '3fef88aa79db1e459fd57b3b443c6021': 'Determine whether the text is empty.',
  '71aedc291e97f05d45d1ff18c9b6db2d':
    'Concatenate multiple input values into text.',
  '9a8dedae5832076dbaed75bb34e7fc24':
    'Return the character corresponding to the numeric code in the computer’s character set. Example: `CHAR(97)` is equivalent to "a".',
  ...
  'a6cd8eab3e54f2248e82f21cfda5129a':
    'Convert the first letter of the input text to uppercase.',
  '819eb11ba92c73ef238880f36a424610':
    'Pad the text to the specified length from the start. Example: `PADSTART("6", 2, "0")`, return `06`.',
  '72049f9ffcee4f1cdfe896b0973f2cff':
    'Convert the text to title case. Example: `CAPITALIZE("star")`, return `Star`.',
  '83d7079f27324f93712d0ad91ca31c8c':
    'Escape the text for HTML. Example: `ESCAPE("<star>&")`, return `&lt;start&gt;&amp;`.',
  '31c98d44caf88fa686e5dfe71d0e617b':
    'Truncate the text by length. Example: `TRUNCATE("amis.baidu.com", 6)`, return `amis...`.',
  '31070d1fd5242417dc836cd0a22f2775':
    'Get all characters before a specific delimiter.',
  '45303b66f886943291c0910aebaed620':
    'Split the text into an array by the specified segment. Example: `SPLIT("a,b,c", ",")`, return `["a", "b", "c"]`.',
  'f567e1f33559d478df5780978825ebf2':
    'Remove leading and trailing spaces from the text.',
  '3f6c03813d8a9cd2ca15eb571faa3644':
    'Remove HTML tags from the text. Example: `STRIPTAG("<b>amis</b>")`, return `amis`.',
  '777e5c82a6326e9ddc0a8b9ee2c3f8f1':
    'Convert line breaks in the string to HTML (for simple line break scenarios). Example: `LINEBREAK("\n")`, return `<br/>`.',
  '33324e6ef7140d16c7093b4b780f4cab':
    'Determine if the string (text) starts with the specified string (startString): return true if yes, false otherwise.',
  'bb2ff3512e864e53e68723e562f3b4bc':
    'Determine if the string (text) ends with the specified string (endString): return true if yes, false otherwise.',
  'f1a369e3432d6e8cd84d7802246cb364':
    'Determine if the text in parameter 1 contains the text in parameter 2: return true if yes, false otherwise.',
  '695226ac1f1bce8cff96212b76d471f0': 'Replace all occurrences in the text.',
  '40de6ff6adf2b1c2f690708dd2f4f5b4':
    'Search the text and return the position of the match.',
  'a8d68e49bcd165601e928772821ef9c6':
    'Return a specific number of characters from the text string starting at the specified position. Example: `MID("amis.baidu.com", 6, 3)`, return `aid`.',
  'fad1d635755dd8fb26d90b1ca0da003c':
    'Return the filename from the path. Example: `/home/amis/a.json`, return `a.json`.',
  '045b831dd1fd3f25be4f1977bec9ef25': 'Generate UUID string',
  'fdd264ef6ebaadcdad6670dd782ebaaa':
    'Create a data object via a string in a specific format or a numeric value. Note that the month value starts from 0: for example, pass 11 for December.',
  ...
  'fc4527e4de2f4b00368f124759ee7f47':
    "Get the day of the week for the date. Example: WEEKDAY('2023-02-27') returns 0. WEEKDAY('2023-02-27', 2) returns 1.",
  '653e1995b9360d5ea17adc62561fa1f2':
    "Get the week of the year (i.e., the week number). Example: WEEK('2023-03-05') returns 9.",
  '3d4ceadcf373d7f9ff18de20ccedd48d':
    "Format dates, date strings, and timestamps. Examples: DATETOSTR('12/25/2022', 'YYYY-MM-DD') returns '2022.12.25', DATETOSTR(1676563200, 'YYYY.MM.DD') returns '2023.02.17', DATETOSTR(1676563200000, 'YYYY.MM.DD hh:mm:ss') returns '2023.02.17 12:00:00', DATETOSTR(DATE('2021-12-21'), 'YYYY.MM.DD hh:mm:ss') returns '2021.12.21 08:00:00'.",
  ...
  '279a4ea3129babc7fe5832aa64948c3c':
    'Return the start of the specified range for the date.',
  'dbd33b41656f944366cab702b2be3b99':
    'Return the end of the specified range for the date.',
  '3c0a1f86074fb104f9fcf2ec9280696c': 'Return the year of the date.',
  '82a490f5b376da13ac2ae5a39cb22c58':
    'Return the month of the date (this refers to the natural month).',
  ...
  '5a05af5aae5fcc038f29a403a18243a5':
    'Return the number of minutes between two dates.',
  '8c202969efa5b5e48553760e07c73018':
    'Return the number of hours between two dates.',
  '56b264e217aacf9fae37934497fae6bd':
    "Modify the date: perform operations like adding/subtracting days, months, years, etc. Example: DATEMODIFY(A, -2, 'month'): subtract 2 months from date A.",
  '7e2e144d81fb33ce97d3cfeedb3651c1':
    "Convert a string date to a date object; the date format can be specified. Example: STRTODATE('2021/12/6', 'YYYY/MM/DD')",
  '01ee2b469a0ed771b7d88d7f37da2775':
    'Determine if the first date comes before the second date: return true if yes, false otherwise.',
  '8951f9f0e6aadf017cb894669aa487c7':
    'Determine if the first date comes after the second date: return true if yes, false otherwise.',
  'f7728fb4212ce3d9dda0957df14d6fc5':
    "Determine if the date is within the specified range: return true if yes, false otherwise. Example: BETWEENRANGE('2021/12/6', ['2021/12/5','2021/12/7']).",
  'ec693de3a5d018aaa34148ab12807ce4':
    'Determine if the first date is before or equal to the second date: return true if yes, false otherwise.',
  '9d5db4d0db5fdc0ba99baf44f1da69b5':
    'Determine if the first date is after or equal to the second date: return true if yes, false otherwise.',
  '95624e7aad7ab31b21af28f2a22e8c41': 'Return the length of the array.',
  '61533e70a6220dea82052941e690c4b8':
    'Transform array data; must be used with an arrow function (note: arrow functions only support single-expression syntax). Convert each element in the array to the value returned by the arrow function. Example: ARRAYMAP([1, 2, 3], item => item + 1) returns [2, 3, 4].',
  '3288dcc0e39872c6fd07911fd5946c4f':
    'Filter array data; must be used with an arrow function (note: arrow functions only support single-expression syntax). Filter out members for which the arrow function returns false. Example: ARRAYFILTER([1, 2, 3], item => item > 1) returns [2, 3].',
  'e9dba27896aa5a79fd794a61c64c3124':
    'Search array data; must be used with an arrow function (note: arrow functions only support single-expression syntax). Find the index of the member for which the arrow function returns true. Example: ARRAYFINDINDEX([0, 2, false], item => item === 2) returns 1.',
  '669d6b5340fc55359ed36bad85ca3c37':
    'Search array data; must be used with an arrow function (note: arrow functions only support single-expression syntax). Find the member for which the arrow function returns true. Example: ARRAYFIND([0, 2, false], item => item === 2) returns 2.',
  '3785b0ca5ae801a018c941eb5ab7b541':
    'Check array members via traversal; must be used with an arrow function (note: arrow functions only support single-expression syntax). Determine if there is any member for which the arrow function returns true: return true if yes, false otherwise. Example: ARRAYSOME([0, 2, false], item => item === 2) returns true.',
  '2e47575507eb5ebadb9bd5ffc01ac12c':
    'When performing data traversal and evaluation, it is necessary to use arrow functions. Note that arrow functions only support single-expression syntax. The evaluation checks whether the return values of the second arrow function are all true; if so, it returns true, otherwise it returns false. Example: ARRAYEVERY([0, 2, false], item => item === 2) returns false.',
  '27e200e541b31e5aca38eb7d8f12667f':
    'Determine if the specified element exists in the data. Example: ARRAYINCLUDES([0, 2, false], 2) returns true.',
  '7ada9f67416ea16540fcb61725e2397f':
    'Filter out false, null, 0 and "" from the array. Example: COMPACT([0, 1, false, 2, \'\', 3]) returns [1, 2, 3].',
  '0b82c69331128197f5653deabe707aee':
    "Convert the array to a string. Example: JOIN(['a', 'b', 'c'], '=') returns 'a=b=c'.",
  'a2ef05f1e4a8af0d5c380307d2cc3cce':
    "Merge arrays. Example: CONCAT(['a', 'b', 'c'], ['1'], ['3']) returns ['a', 'b', 'c', '1', '3'].",
  '3c227600a4af0574e8782e96455862a9':
    "Remove duplicates from the array; the second parameter 「field」 allows specifying a field to deduplicate by. Example: UNIQ([{a: '1'}, {b: '2'}, {a: '1'}]) returns [{a: '1'}, {b: '2'}].",
  'b90e85a6f375f73dcc262c0803fbf7af':
    'Convert a JS object to a JSON string. Example: ENCODEJSON({name: \'amis\'}) returns \'{\\"name\\":\\"amis\\"}\'.',
  '3effcacff99f8e3a6c560990bc0c5e7b':
    'Parse JSON-encoded data and return a JS object. Example: DECODEJSON(\'{\\"name\\": "amis"}\') returns {name: \'amis\'}.',
  ...
  '595574852a6aef47b344381515745911':
    'Check if the type is supported: string, number, array, date, plain-object.'
});
